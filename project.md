...
There is no explicit "Game Over" or "You Lose." The game simply evaluates the built bowl.
* **Visual Plate:** A visual chart (e.g., a pie chart of macros, or an infographic of water droplets/trees chopped).
* **Final Stats:** Exact numbers vs. Targets.
* **The Feedback Section:** A stylized receipt or "Yelp Review" from the diner, populated by the Evaluation Rules (see Section 5).
* **Button:** "Next Customer" (Starts a new round).
