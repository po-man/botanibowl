...
- **Results Screen Component**:
  - **Visual Plate**: Pie chart for macros, icons for eco impact (water droplets, trees).
  - **Stats Display**: Table or list of final vs. target values.
  - **Feedback Section**: Compiled text from evaluation rules, styled as a receipt.
  - Handles "Next Customer" to restart round.
